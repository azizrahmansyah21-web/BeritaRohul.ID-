                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.contact.send-replay') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" id="" class="form-control" {{ getLangauge() == 'fa' ? 'dir=rtl' : 'dir=ltr' }} >
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="message" class="form-control" style="height: 200px !important;"  {{ getLangauge() == 'fa' ? 'dir=rtl' : 'dir=ltr' }}></textarea>
                                @error('message')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
