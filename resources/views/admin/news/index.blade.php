                    ...
                    @foreach ($languages as $language)
                        <li class="nav-item">
                            <a class="nav-link {{ $loop->index === 0 ? 'active' : '' }}"
                               id="home-tab2-{{ $language->lang }}"
                               data-toggle="tab"
                               href="#home-{{ $language->lang }}"
                               role="tab"
                               aria-controls="home-{{ $language->lang }}"
                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                    @foreach ($languages as $language)
                        ...
                        <div class="tab-pane fade show {{ $loop->index === 0 ? 'active' : '' }}"
                             ...
                             role="tabpanel"
                             aria-labelledby="home-tab2-{{ $language->lang }}">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped news-table" id="table-{{ $language->lang }}">
                                        <thead>
                                            <tr>
