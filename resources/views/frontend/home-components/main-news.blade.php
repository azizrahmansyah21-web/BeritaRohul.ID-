                            ...
                            <div class="wrap__social__media">
                                @foreach ($socialCounts as $socialCount)
                                    <a href="{{ $socialCount->url }}" target="_blank">
                                        <div class="social__media__widget mt-4" style="background-color:{{ $socialCount->color }}">
                                        <span class="social__media__widget-icon ml-2 mt-2">
                                            <i class="{{ $socialCount->icon }}"></i>
                                        </span>
                                            <span class="social__media__widget-counter" style="text-align: center">
                                                {{ $socialCount->fan_count }} {{ $socialCount->fan_type }}

                                        </span>
                                            <span class="social__media__widget-name mt-1">
