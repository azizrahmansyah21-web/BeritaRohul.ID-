                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-name">
                                    ...
                                    <input type="text" class="form-control" name="subject" required="" {{ getLangauge() == 'fa' ? 'dir=rtl' : 'dir=ltr' }}>
                                    @error('subject')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="8" name="message" required="" {{ getLangauge() == 'fa' ? 'dir=rtl' : 'dir=ltr' }}></textarea>
                                    @error('message')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
