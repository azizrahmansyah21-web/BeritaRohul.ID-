...
Route::group(['prefix'=>'admin','as'=>'admin.'],function (){
    Route::get('login',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'login'])->name('login');
    Route::post('login',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'handlelogin'])->name('handleLoginRequest');
    Route::post('logout',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'logout'])->name('logout');

    /* admin reset password*/
    Route::get('forgot-password',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'forgotPassword'])->name('forgot-password');
    Route::post('forgot-password',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'sendresetlink'])->name('forgot-password.send');
    Route::get('reset-password/{token}/{email}',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'resetPassword'])->name('reset-password');

    Route::post('reset-password',[App\Http\Controllers\Admin\AdminAuthenticationController::class,'handleresetPassword'])->name('reset-password.send');
...
Route::group(['prefix'=>'admin','as'=>'admin.','middleware'=>[App\Http\Middleware\Admin::class]],function (){
    ...
    //profile routes
    /**Profile Routes */
    Route::put('profile-password-update/{id}', [ App\Http\Controllers\Admin\ProfileController::class, 'passwordUpdate'])->name('profile-password.update');
    ...
    Route::post('news/upload-image', [NewsController::class, 'uploadImage'])->name('news.upload_image'); //added for summernote image upload
