...
class SocialLinkController extends Controller implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            ...
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('social link  index,admin'), only:['index']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('social link  create,admin'), only:['create','store']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('social link  update,admin'), only:['edit','update']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('social link  delete,admin'), only:['destroy']),
