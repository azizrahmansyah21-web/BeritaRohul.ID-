...
class AdController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('advertisment index,admin'), only:['index']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('advertisment update,admin'), only:['update']),
