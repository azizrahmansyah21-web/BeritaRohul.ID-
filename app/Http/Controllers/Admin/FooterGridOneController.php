...
//    }
    public static function middleware(): array
    {
        return [
            ...
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('footer create,admin'), only:['create','store']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('footer update,admin'), only:['edit','update','handleTitle']),
            new Middleware(\Spatie\Permission\Middleware\PermissionMiddleware::using('footer delete,admin'), only:['destroy']),
